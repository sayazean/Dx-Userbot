...
async def checking():
    gocheck = str(pybase64.b64decode("QEFiaW5nU3VwcG9ydA=="))[2:15]
    checker = str(pybase64.b64decode("QEFiaW5nUHJvamVjdA=="))[2:16]
    checker2 = str(pybase64.b64decode("QGluaWFiaW5n"))[2:16]
    try:
