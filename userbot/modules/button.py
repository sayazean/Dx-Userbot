...
from userbot.utils import edit_delete, zean_cmd, reply_id
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}button test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/AbingProject:same> [Support]<buttonurl:https://t.me/AbingSupport>`\
    "
    }
)
