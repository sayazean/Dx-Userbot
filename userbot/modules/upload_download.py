...
from userbot.utils import progress, humanbytes, edit_or_reply, edit_delete, zean_cmd


@zean_cmd(pattern="download(?: |$)(.*)")
...
@zean_cmd(pattern="uploadas(stream|vn|all) (.*)")
