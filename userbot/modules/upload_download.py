...
from userbot.utils import progress, humanbytes, edit_or_reply, edit_delete, bing_cmd


@bing_cmd(pattern="download(?: |$)(.*)")
...
@bing_cmd(pattern="uploadas(stream|vn|all) (.*)")
